...
class AuthService {
  ...
  String _mapUnknownAuthError(Object error) {
    ...
    if (lower.contains('recaptcha') ||
      ...
      return 'Verification failed due to a temporary network issue. Please try again.';
    }

    return 'Authentication failed due to an unexpected error. Please try again.';
  }
